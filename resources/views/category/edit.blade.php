<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('updateCategory')}}" method="POST" id="editForm">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <select name="restaurant" id="edit_restaurant" class="browser-default custom-select" style="margin-top: 18px;">
