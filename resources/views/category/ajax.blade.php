                ...
                $.ajax({
                    ...
                    success:function(response) {
                        if(response.success == true) {
                            ...
                            manageTable.ajax.reload(null, false);
                            // close the modal
                            toastr.success('Deleted Successfully.', 'Category', {timeOut: 3000});
                            $("#modalConfirmDelete").modal('hide');
                            $(".loader-ajax").hide();

                        } else {
                            toastr.error('Not Deleted.', 'Category', {timeOut: 3000});
                        }
                    }
                });
            }); // click remove btn
...
// fetch the member data
            $.ajax({
                ...
                success:function(response) {
                    ...
                    $("#edit_name").val(response.categories.name);

                    $("#edit_restaurant").empty();
                    $("#edit_restaurant").append(response.restaurant);
                    $('#edit_restaurant').material_select();
