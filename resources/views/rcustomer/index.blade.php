...
{{--                    </a>--}}
                    <div class="table-responsive text-nowrap">
                        ...
                        <table id="list" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tr>
								...
								<th class="th-sm">Approved Corporate Booking
                                    <i class="fa fa-sort float-right" aria-hidden="true"></i>
                                </th>
            ...
            <a title="Add Customer" href="" class="btn-floating gray fixed-bottom-right" data-toggle="modal" data-target="#modalAddCustomer"><i class="fa fa-plus mt-0"></i></a>
...
@section('search')
    @include('rcustomer.search')
@endsection

@section('edit')
    @include('rcustomer.edit')
    @include('rcustomer.edit-customer')
@endsection

@section('create')
    @include('rcustomer.create')
@endsection

@section('show')
    @include('rcustomer.show')
@endsection
