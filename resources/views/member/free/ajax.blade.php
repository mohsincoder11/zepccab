...
// validation
    ...
    function PatientDetailsInsert(id = null) {
        if(id) {
...
// mmeber id
                    $("#editForm1").append('<input type="hidden" name="id" id="edit_id" value="'+id+'"/>');

// here update the location data
                    $("#editForm1").unbind('submit').bind('submit', function() {
// remove error messages
                        $(".text-danger").remove();
