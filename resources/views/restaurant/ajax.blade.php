...
// remove the error
                    ...
                    if(response.success == true) {
                        ...
                        toastr.success('Added Successfully.', 'Restaurant', {timeOut: 5000});
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        if(response.success == true) {
                            ...
                            manageTable.ajax.reload(null, false);
                            // close the modal
                            toastr.success('Deleted Successfully.', 'Restaurant', {timeOut: 3000});
...
// fetch the member data
            $.ajax({
                ...
                success:function(response) {
                    ...
                    $("#edit_name").val(response.restaurants.name);
                    $("#edit_tags").val(response.restaurants.tags);
                    $("#edit_address").val(response.restaurants.address);

                    $("#edit_city").empty();
                    $("#edit_city").append(response.cities);
                    $('#edit_city').material_select();
