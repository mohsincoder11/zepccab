<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('updateRestaurant')}}" method="POST" id="editForm">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <select name="city" id="edit_city" class="browser-default custom-select" style="margin-top: 18px;">
                        ...
                        <div class="col">
                            <div class="md-form mt-3">
                                <input type="text" id="edit_tags" name="tags" class="form-control" autocomplete="off">
                                <label for="tags" class="input-active">Tag</label>
                            </div></div>
