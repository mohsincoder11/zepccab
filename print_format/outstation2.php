...
$get_value_one = $data['perkm_amount'] * $data['distance'];
...
$final = $cal_min + $get_value_one + $data['toll_n_parking_desc'] + $data['night_hault_desc'];
...
<table id="table" widht="100%">
  ...
  <tr>
   ...
   <tr>
     <td >1</td>
     <td >Rate: '.$data['perkm_amount'].' Rs/Kms</td>
