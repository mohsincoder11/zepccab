...
$days_final  = $data['per_day_amount'] * $data['days'];
$amount_trip = $data['perkm_amount'] * $data['distance'];
$cal_min = $data['customer_extra_time'] * $data['extra_per_min_rate'];
$final = $cal_min + $days_final + $data['toll_n_parking_desc'] + $data['night_hault_desc'] + $data['total_average_amount'];
...
<table id="table" widht="100%">
  ...
  <tbody>
   ...
   <tr>
     <td >1</td>
     <td >Rate: '.$data['per_day_amount'].' Rs for 12 Hrs</td>
   ...
   <tr >
     <td ></td>
     <td>'.$data['per_day_desc'].'</td>
     <td >'.$data['distance'].' Kms</td>
     <td >'.$data['total_average_amount'].' Rs</td> 
   </tr>
